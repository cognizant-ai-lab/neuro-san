...
class BranchActivationPrepper(ActivationPrepper):
    """
    ActivationPrepper implementation for BranchActivations.
    """
    ...
    def is_applicable(self, agent_tool_spec: Dict[str, Any]) -> bool:
        ...
        """
        return agent_tool_spec.get("function") is not None and agent_tool_spec.get("class") is None
