...
class ToolboxInfoRestorer(AbstractAsyncConfigRestorer):
    """
    Implementation of the AbstractAsyncConfigRestorer interface to read in a ToolboxInfo dictionary
    instance given a hocon file name.
    Both restore() and async_restore() return dictionaries.
    """
    ...
    def __init__(self):
        ...
        Constructor
        """
        super().__init__(file_purpose="toolbox_info")
    ...
    def get_file_path(self, file_reference: str = None) -> str:
        ...
        :param file_reference: The file reference to use when restoring.
                ...
                implementation.
        :return: a string represting the file path to use
        """
