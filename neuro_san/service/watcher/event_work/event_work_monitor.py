...
class EventWorkMonitor(Startable):
    ...
    def __init__(self, event_work_queue: AsyncCollatingQueue):
        """
        Constructor

        :param event_work_queue: The AsyncCollatingQueue containing event work
        """
        self.event_work_queue = event_work_queue
