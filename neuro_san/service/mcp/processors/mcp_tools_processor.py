...
class McpToolsProcessor:
    ...
    async def call_tool(self, request_id, metadata: Dict[str, Any],
        ...
        call_result: Dict[str, Any] =\
            await self.build_tool_call_result(request_id, response_text, response_structure, response_sly_data)
        return call_result
    ...
    async def build_tool_call_result(
            ...
            result_sly_data: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _extract_tool_response_part(
        ...
        :return: tuple of 3 values:
            ...
            sly data part as dictionary or None
        """
        ...
        if response_type == "AGENT_FRAMEWORK":
            ...
            return text, structure_data, sly_data
