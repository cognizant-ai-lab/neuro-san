...
class TestLangChainRunContextProviderTools(TestCase):
    ...
    @staticmethod
    def _make_context(provider_tools=None) -> LangChainRunContext:
    ...
    def test_create_agent_appends_provider_tools(self, create_agent_mock, middleware_factory_mock):
    ...
    def test_create_agent_without_provider_tools_uses_base_tools(
        self, create_agent_mock, middleware_factory_mock
    ):
    ...
    @patch("neuro_san.internals.run_context.langchain.core.langchain_run_context.MiddlewareFactory")
    def test_real_create_agent_binds_provider_tool(self, middleware_factory_mock):
